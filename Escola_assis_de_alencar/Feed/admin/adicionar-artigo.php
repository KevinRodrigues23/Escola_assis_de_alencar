...
<div class="container-sm">
  ...
  <input type="text" class="form-control"name="nome" id="exampleFormControlInput1" placeholder="Nome do professor">
        ...
        <div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label"><b>Título</b></label>
  <input type="text" class="form-control"name="título" id="exampleFormControlInput1" placeholder="título">
</div>
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label"><b>Escreva o relatório</b></label>
