      ...
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="../../admin/configuracao.php">Configuração <i class="fa fa-cogs" aria-hidden="true"></i></a></li>
          </ul>
        </li>
      
      </ul>
   
        <a class="btn btn-outline-success text-white bg-success" href="../../../assets/logout.php">Logout <i class="fa fa-sign-out" aria-hidden="true"></i></a>
